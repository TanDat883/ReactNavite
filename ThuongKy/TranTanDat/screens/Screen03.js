    ...
    <View style={{ marginTop: 50, marginHorizontal: 20 }}>
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
        <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
          <Image
            source={require('../assets/Avatar31.png')}
      ...
      <Tooltip
        popover={<Text>Enter the name of your job here.</Text>}
        isVisible={tooltipVisible}
        onClose={() => setTooltipVisible(false)}
      >
        <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: "#F2F2F2", marginVertical: 20, padding: 10, borderWidth: 1, borderRadius: 10 }}>
          <Entypo
            name="text-document"
            size={24}
            color="#40A263"
